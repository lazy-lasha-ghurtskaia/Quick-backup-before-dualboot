...
void render_scene(SDL_Renderer** renderer, SDL_Texture** texture, point3D p, point3D p2, point3D p3)
{
	SDL_Vertex vertex[3] = {p.pt, p2.pt, p3.pt};

	SDL_SetRenderDrawColor(*renderer, 0, 0, 0, 0xff);
	SDL_RenderClear(*renderer);

	SDL_RenderGeometry(*renderer, *texture, vertex, 3, NULL, 0);
...
int main(int argc, char **argv)
{
	...
	point3D p = {0, 300, 0,    0, 0, 0,  
		{ {0, 0}, {255,255,255,255}, {0.5,-0.15}, },	 
	};
	point3D p2 = {-200, 0, 0,    0, 0, 0,  
		{ {0, 0}, {255,255,255,255}, {0,0.9}, },	 
	};
	point3D p3 = {200, 0, 0,    0, 0, 0,  
		{ {0, 0}, {255,255,255,255}, {1,0.9}, },	 
	};
	...
	if (!sdl_init(&gWindow, &gRenderer)){
		...
		if (!sdl_load(&gRenderer, &gTexture)){
			...
			render_scene(&gRenderer, &gTexture, p, p2, p3);
